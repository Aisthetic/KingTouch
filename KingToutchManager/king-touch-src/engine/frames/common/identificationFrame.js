...
exports.processIdentification = function(logg,connection,token,username,cb,identificationTimeoutCallBack){
	global.serversInfos = {appVersion:"1.9.27", buildVersion:"0.59.1", client:"android", language:global.config.language};//todo mettre les value qq part jais pas encore fais le systeme de config static ....
	logger=logg;
